            ...
            <View className="bg-[#1A1F2E]/95 backdrop-blur-xl rounded-t-3xl overflow-hidden shadow-2xl border-t border-white/10" {...panResponder.panHandlers}>
              ...
              <View className="p-5">
                <View className="items-center mb-6">
                  <Text className="text-white text-2xl font-bold mb-1">Reading Level</Text>
                  <Text className="text-gray-300 text-sm">Select your reading proficiency</Text>
                </View>
                ...
                <View className="space-y-4 mb-6">
                  ...
                  >
                    ...
                    <View className="flex-1">
                      <Text className="text-white font-semibold text-base">Basic</Text>
                      <Text className="text-gray-300 text-xs">Simple texts and vocabulary</Text>
                    </View>
                  ...
                  >
                    ...
                    <View className="flex-1">
                      <Text className="text-white font-semibold text-base">Advanced</Text>
                      <Text className="text-gray-300 text-xs">Complex texts and vocabulary</Text>
                    </View>
                    <View className="w-8 h-8 rounded-full bg-white/10 items-center justify-center">
                      <Ionicons name="chevron-forward" size={16} color="#FFFFFF" />
                    </View>
