  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <ScrollView className="flex-1 px-4 pt-8">
        ...
        {/* CTA */}
        <TouchableOpacity style={{ backgroundColor: '#8A5CFF', borderRadius: 10, paddingVertical: 14, marginBottom: 30 }} onPress={() => handleNavigation('/live-sessions')}>
