    ...
    <View className="flex-1 bg-slate-900">
      ...
      <SafeAreaView className="flex-1">
        ...
        >
          ...
          {/* Tab Navigation */}
          <View className="absolute bottom-0 left-0 right-0 bg-[#0F172A]/90 blur-lg rounded-t-3xl z-50 border-t border-white/10">
            <View className="flex-row justify-around items-center py-2">
              {TABS.map((tab) => {
      ...
      {/* Bottom Navigation */}
      <BottomNav setShowLevelModal={setShowLevelModal} />
      ...
      <LevelSelectionModal
        ...
        onSelectLevel={(selectedLevel) => {
          ...
          if (selectedLevel === "Basic") {
            router.push("/basic-contents");
          } else {
            router.push("/advanced-contents");
          }
        }}
      />
