...
/* 🔹 Minimal additions (same pattern as Lesson 2) */
const lessonPrompt = "List a one-sentence script for the users to read, about the topic";
const topic = "Mastering Rhetorical Devices";
const criteria = "";
const display = "Lesson 3"; // shown/forwarded to live-vid-selection
...
const LESSONS: LessonDetail[] = [
  {
    ...
    intro: `Rhetorical devices are creative ways of using language to make your speech more powerful and interesting. They help you catch attention, highlight ideas, and make your message easy to remember.`,
    importance: [
      "Makes your speech more engaging and emotional.",
      "Helps people remember your message.",
      "Shows your creativity and understanding of language."
    ],
    tips: [
      "Repeat words at the start of phrases for rhythm “We fight for peace, we fight for justice, we fight for freedom.”",
      "Use opposites to show contrast “Without effort, there is failure; with effort, there is success.”",
      "Compare two things to make meaning vivid “Books are windows to the world.”"
    ],
    taskInstructions: [
      "Read this plain sentence: “Education is important for our future",
      "Focus on anaphora (repetition), antithesis (contrast), and metaphor (imagery)",
      "Ensure your read version enhances clarity and impact",
      "Practice reading your revised text aloud with expressive delivery",
      "Record yourself and compare the before/after versions"
    ],
    taskBody: `Task: Rewrite a paragraph with 3 rhetorical devices and read aloud.

Task Example:
Read this plain sentence: “Education is important for our future."

Then, create your own improved version using at least three rhetorical devices. Record yourself reading both versions (plain and improved).`,
    rubric: [
      {
        label: "Accuracy",
        descriptions: {
    ...
    references: [
      ...
      { url: "https://writingcenter.fas.harvard.edu/pages/strategies-essay-writing" }
    ]
  }
];
      ...
      <ScrollView className="flex-1" contentContainerStyle={{ paddingBottom: 30 }}>
        <View className="bg-gradient-to-b from-white/5 to-white/10 rounded-2xl p-4 border border-white/10 mt-10 mb-4 mx-4">
          ...
          <View className="mb-10">
            <Text className="text-white text-sm top-4 leading-5">Task: Rewrite a paragraph with 3 rhetorical devices and read aloud.</Text>
          </View>
          ...
          <View className="flex-row justify-between mt-2 space-x-3">
            ...
            {/* 🔗 Start Recording → pass same params as Lesson 2; NOTHING ELSE CHANGED */}
            <TouchableOpacity 
              onPress={() => router.push({
