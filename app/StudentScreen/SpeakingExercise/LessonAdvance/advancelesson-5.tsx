...
const LESSONS: LessonDetail[] = [
  {
    ...
    intro: `Credibility comes from a mix of confidence, knowledge, and authenticity. It’s built through ethos (credibility), honesty, and consistent delivery.`,
    importance: [
      ...
      <ScrollView className="flex-1" contentContainerStyle={{ paddingBottom: 30 }}>
        <View className="bg-gradient-to-b from-white/5 to-white/10 rounded-2xl p-4 border border-white/10 mt-10 mb-4 mx-4">
          ...
          <View className="mb-10">
            <Text className="text-white text-sm top-4 leading-5">Task: Deliver a 2-min informative talk using at least 3 credibility techniques.</Text>
          </View>
