...
const LESSONS: LessonDetail[] = [
  {
    ...
    intro: `Answering questions after a speech can be stressful — but it’s also your chance to show confidence and knowledge. In this lesson, you’ll practice the Clarify → Answer → Bridge method to stay calm and give smart, clear answers.`,
    importance: [
      "Shows that you know your topic.",
      "Proves you respect and understand your audience.",
      "Builds confidence for defenses and presentations."
    ],
    tips: [
      "Listen carefully to the question.",
      "Keep your answer short — around 20 to 30 seconds.",
      "If you forget something, pause and breathe.",
      "End by bridging back to your main message."
    ],
    taskInstructions: [
      "Practice answering 5 different questions using the Clarify → Answer → Bridge method",
      "Listen carefully to each question before responding",
      "Keep your answers concise (20-30 seconds each)",
      "Bridge back to your main message when appropriate",
      "Maintain calm and confident body language throughout",
      "Record your Q&A session and review your performance"
    ],
    taskBody: `Task: Record yourself answering this short question “What helps you improve your English communication?”
    
You will practice using the Clarify → Answer → Bridge technique.
               
Example Practice:

Question: “What makes you nervous when speaking in front of others?”

Clarify: “That’s a great question — I think you mean stage fright, right?”

Answer: “I get nervous when many people are watching, especially if I forget what to say.” 

Bridge: “But the more I practice, the more confident I become — that’s why I keep joining speaking tasks like this.”`,
    rubric: [
      {
        label: "Clarifying",
        descriptions: {
          high: "Always restates/clarifies question",
          medium: "Sometimes clarifies",
      ...
      },
      {
        label: "Calmness",
        descriptions: {
          high: "Speaks steady and confident",
          medium: "Some nervousness",
          low: "Very tense"
        }
      },
      {
        label: "Bridging",
        descriptions: {
          high: "Links back to main message",
          medium: "Inconsistent",
          low: "No bridging"
        }
      }
    ...
    references: [
      { url: "https://hbr.org/2016/11/how-to-handle-tough-questions-in-a-presentation" },
      { url: " https://www.toastmasters.org/magazine/magazine-issues/2020/july/qa-tips" }
    ]
  }
];
    ...
    <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }} className="flex-1">
      <ScrollView className="flex-1" contentContainerStyle={{ paddingBottom: 30 }}>
        <View className="bg-gradient-to-b from-white/5 to-white/10 rounded-2xl p-4 border border-white/10 mb-4 mx-4">
          ...
          {/* Advanced rule hint: progress updates on results only */}
          <Text className="text-white/60 text-center text-xs mt-1">
            Note: For advanced lessons, progress updates after you finish and view your results.
          </Text>
        </View>
      </ScrollView>
    </Animated.View>
          ...
          <View className="bg-white/10 p-4 rounded-lg mb-6">
            ...
            <View className="space-y-2">
              <View className="flex-row items-start">
                <Text className="text-violet-400 mr-2">👂</Text>
                <Text className="text-white/80 text-sm">Listen fully to the entire question before answering</Text>
              </View>
              <View className="flex-row items-start">
                <Text className="text-violet-400 mr-2">⏱️</Text>
                <Text className="text-white/80 text-sm">Keep answers concise (20-30 seconds maximum)</Text>
              </View>
              <View className="flex-row items-start">
                <Text className="text-violet-400 mr-2">🌉</Text>
                <Text className="text-white/80 text-sm">Bridge back to your main message when possible</Text>
              </View>
              <View className="flex-row items-start">
                <Text className="text-violet-400 mr-2">😌</Text>
                <Text className="text-white/80 text-sm">Stay calm and maintain steady speaking pace</Text>
              </View>
              <View className="flex-row items-start">
                <Text className="text-violet-400 mr-2">🔄</Text>
                <Text className="text-white/80 text-sm">Use the Clarify → Answer → Bridge method consistently</Text>
              </View>
            </View>
          </View>
        ...
        <View className="bg-gradient-to-b from-white/5 to-white/10 rounded-2xl p-4 border border-white/10 mt-10 mb-4 mx-4">
          ...
          <View className="mb-10">
            <Text className="text-white text-sm top-4 leading-5">
              Task: Answer 5 questions using the “Clarify → Answer → Bridge” method.
            </Text>
            <Text className="text-white/60 text-xs mt-3">
              Progress updates to 100% after you finish and view your results.
            </Text>
          </View>
...
export default function LessonScreen() {
  ...
  const params = useLocalSearchParams();
  const lessonId = parseInt((params.id as string) || "4", 10) || 4;
