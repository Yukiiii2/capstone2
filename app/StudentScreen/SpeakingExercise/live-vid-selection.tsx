...
export default function LiveVidSelection() {
  ...
  // BottomNav removed. Use shared NavigationBar if needed.
          ...
          <View className="px-3 -mt-8 mb-5">
            <View className="flex-row justify-center items-center space-x-6 w-full">
              <TouchableOpacity
                ...
                activeOpacity={0.8}
                onPress={() => router.push("StudentScreen/SpeakingExercise/live-video-recording")}
              >
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.8}
                onPress={() => router.push("StudentScreen/SpeakingExercise/private-video-recording")}
              >
