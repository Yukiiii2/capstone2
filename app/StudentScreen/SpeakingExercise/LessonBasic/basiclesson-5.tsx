...
const lessonPrompt =
  "Listen to a short speech and summarize the main idea in 1–2 sentences in your own words.";
const topic = "Active Listening Skills";
...
const LESSONS: LessonDetail[] = [
  {
    ...
    subtitle: "Basic • Lesson 5",
    intro:
      "Active listening means focusing fully on the speaker, understanding their message, and responding thoughtfully.",
    importance: [
    ...
    quiz: [
      {
        ...
        correct: 1, // fixed (correct: Fully focusing on the speaker)
      },
      {
        id: 2,
        question: "What shows active listening?",
        options: ["Eye contact", "Interrupting", "Looking away", "Daydreaming"],
        correct: 0, // fixed (correct: Eye contact)
      },
    ],
    taskBody:
      "Listen to a short 1–2 minute speech. After listening, write or say a 1–2 sentence summary of the main idea.",
    rubric: [
      { 
        label: "Main Idea Recall", 
        descriptions: {
          high: "Summary captures the central idea clearly",
          medium: "Summary captures part of the idea",
          low: "Summary misses or distorts the idea"
        }
      },
      { 
        label: "Clarity", 
        descriptions: {
          high: "Expressed in own words, clear and concise",
          medium: "Understandable but slightly unclear/repetitive",
          low: "Confusing, vague, or off-topic"
        }
      },
      { 
        label: "Completeness", 
        descriptions: {
          high: "Covers essential points in 1–2 sentences",
          medium: "Covers some points but incomplete",
          low: "Very limited, missing key points"
        }
      }
    ],
    references: [
      { url: "https://www.mindtools.com/az4m90h/active-listening"},
      { url: "https://www.forbes.com/sites/ashleystahl/2020/01/27/7-ways-to-improve-your-listening-skills"}
    ]
  }
];
...
const BASIC_ORDER_INDEX_FOR_THIS = 5; // Basic Lesson #5
...
const saveQuizProgress50 = async (): Promise<void> => {
  try {
    ...
    // Resolve module_id for speaking/basic/order_index = 5
...
// Quiz Section (shuffled choices + 50% progress write on Done)
...
export default function LessonScreen() {
  ...
  const lessonId = parseInt(params.id as string) || 5;
