...
const WordList = () => (
  <View className="mb-6">
    ...
    <View className="bg-white/5 p-4 rounded-lg">
      <Text className="text-white text-center text-sm font-semibold mb-4">The Voice of Responsibility</Text>
      <Text className="text-white text-justify leading-relaxed">
      True freedom is not the absence of rules, but the presence of responsibility. Every choice we make affects others, whether we realize it or not. Responsible individuals think before they act, respect differences, and contribute positively to their community. In a world that values instant results, patience and understanding remain powerful virtues.
      </Text>
    </View>
  </View>
);
...
const Instructions = () => (
  <View className="mb-6">
    ...
    <View className="bg-white/5 p-4 rounded-lg">
      <Text className="text-white mb-2">1. Read confidently, emphasizing key ideas.</Text>
      <Text className="text-white mb-2">2. Reflect meaning through tone and pacing.</Text>
      <Text className="text-white">3. AI evaluates fluency, tone emphasis, clarity, and comprehension.</Text>
    </View>
  </View>
);
...
const FocusArea = () => (
  <View className="mb-6">
    ...
    <View className="bg-purple-500/20 p-4 rounded-lg border-l-4 border-purple-500">
      <Text className="text-white">Pronunciation, expression, critical tone, and persuasive delivery.
      </Text>
    </View>
  </View>
);
...
export default function ReadingExercise() {
  ...
  const handleStartReading = () => {
    ...
    router.push("/StudentScreen/ReadingExercise/student-voice-reading-recording");
  };
  ...
  return (
    <View className="flex-1 bg-gray-900">
      ...
      <ScrollView className="flex-1" contentContainerStyle={{ padding: 20, paddingTop: 20 }}>
        {currentPage === 0 ? (
          <View>
            <Text className="text-2xl font-bold text-white mb-2">Critical Reading (Persuasive or Reflective Texts)</Text>
            <Text className="text-purple-300 mb-6">Reading Advance Level 3</Text>
            
            <View className="bg-white/5 p-6 rounded-2xl border border-white/10 mb-6">
              <Text className="text-white text-lg mb-4">
              Objective:
              Read complex and persuasive texts fluently, with tone and emphasis that reflect understanding and interpretation of meaning.
              </Text>
