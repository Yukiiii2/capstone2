...
const WordList = () => (
  <View className="mb-6">
    ...
    <View className="bg-white/5 p-4 rounded-lg">
      <Text className="text-white text-center text-sm font-semibold mb-4">The Role of Technology in Education</Text>
      <Text className="text-white text-justify leading-relaxed">
        Technology has transformed how students learn and teachers teach. Digital tools allow learners to access lessons anytime and anywhere. Through virtual simulations, students can experience real-life scenarios without leaving the classroom. However, using technology responsibly is essential to ensure it supports learning rather than distracts from it.
      </Text>
    </View>
  </View>
);
...
const Instructions = () => (
  <View className="mb-6">
    ...
    <View className="bg-white/5 p-4 rounded-lg">
      <Text className="text-white mb-2">1. Read clearly and naturally, emphasizing keywords.</Text>
      <Text className="text-white mb-2">2. Maintain an even pace suitable for informational reading.</Text>
      <Text className="text-white">3. AI evaluates pronunciation, clarity, and tone appropriate for academic texts.</Text>
    </View>
  </View>
);
...
const FocusArea = () => (
  <View className="mb-6">
    ...
    <View className="bg-purple-500/20 p-4 rounded-lg border-l-4 border-purple-500">
      <Text className="text-white">Pronunciation accuracy, academic tone, and comprehension pacing.
      </Text>
    </View>
  </View>
);
...
export default function ReadingExercise() {
  ...
  const handleStartReading = () => {
    const content = "The Role of Technology in Education\n\nTechnology has transformed how students learn and teachers teach. Digital tools allow learners to access lessons anytime and anywhere. Through virtual simulations, students can experience real-life scenarios without leaving the classroom. However, using technology responsibly is essential to ensure it supports learning rather than distracts from it.";
    const title = "The Role of Technology in Education";
  ...
  return (
    <View className="flex-1 bg-gray-900">
      ...
      <ScrollView className="flex-1" contentContainerStyle={{ padding: 20, paddingTop: 20 }}>
        {currentPage === 0 ? (
          <View>
            <Text className="text-2xl font-bold text-white mb-2">Informative Reading</Text>
            <Text className="text-purple-300 mb-6">Reading Advance Level 1</Text>
            
            <View className="bg-white/5 p-6 rounded-2xl border border-white/10 mb-6">
              <Text className="text-white text-lg mb-4">
              Objective:
              Demonstrate clear and fluent reading of informational or academic passages while maintaining understanding of key details.
              </Text>
