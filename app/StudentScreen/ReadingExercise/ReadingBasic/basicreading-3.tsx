...
const WordList = () => (
  <View className="mb-6">
    ...
    <View className="bg-white/5 p-4 rounded-lg">
      <Text className="text-white text-center text-xl font-semibold mb-4">The Power of Reading</Text>
      <Text className="text-white text-justify leading-relaxed">
        Reading is one of the best ways to improve our minds. It helps us understand new ideas and discover different worlds. When I read, I imagine the story in my mind and feel the emotions of the characters. Reading also teaches me new words and helps me express my thoughts better. Every page I finish makes me feel proud and inspired to learn more.
      </Text>
    </View>
  </View>
);
...
const Instructions = () => (
  <View className="mb-6">
    ...
    <View className="bg-white/5 p-4 rounded-lg">
      <Text className="text-white mb-2">1. Read the paragraph clearly and confidently.</Text>
      <Text className="text-white mb-2">2. Use tone and emotion to show meaning.</Text>
      <Text className="text-white">3. AI measures pronunciation, pace, clarity, and expression.</Text>
    </View>
  </View>
);
...
const FocusArea = () => (
  <View className="mb-6">
    ...
    <View className="bg-purple-500/20 p-4 rounded-lg border-l-4 border-purple-500">
      <Text className="text-white">Pronunciation, fluency, clarity, and expression.</Text>
    </View>
  </View>
);
...
export default function ReadingExercise() {
  ...
  const handleStartReading = () => {
    const content = "The Power of Reading\n\nReading is one of the best ways to improve our minds. It helps us understand new ideas and discover different worlds. When I read, I imagine the story in my mind and feel the emotions of the characters. Reading also teaches me new words and helps me express my thoughts better. Every page I finish makes me feel proud and inspired to learn more.";
    router.push({
      pathname: "/StudentScreen/ReadingExercise/student-voice-reading-recording",
      params: { content, title: "Short Paragraph" }
    });
  };
  ...
  return (
    <View className="flex-1 bg-gray-900">
      ...
      <ScrollView className="flex-1" contentContainerStyle={{ padding: 20, paddingTop: 20 }}>
        {currentPage === 0 ? (
          <View>
            <Text className="text-2xl font-bold text-white mb-2">Short Paragraph</Text>
            <Text className="text-purple-300 mb-6">Reading Basic Level 3</Text>
            
            <View className="bg-white/5 p-6 rounded-2xl border border-white/10 mb-6">
              <Text className="text-white text-lg mb-4">
                Task: Students click “Start Reading – Level 3” and read the passage below with natural expression.
              </Text>
