  ...
  return (
    <View className="flex-1 bg-[#0A0A1E]">
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View className="flex-row items-center justify-between px-4 pt-8 pb-3">
          ...
          <View className="flex-row items-center space-x-2">
            ...
            <View className="w-8 h-8 rounded-full ml-1 bg-white/20 border border-white/10 items-center justify-center">
              <Image source={{ uri: 'https://randomuser.me/api/portraits/men/32.jpg' }} className="w-7 h-7 rounded-full" />
            </View>
          </View>
        </View>
        ...
        <Text className="text-gray-300 px-4 mb-4">Record yourself and get AI-powered feedback to improve your presentation skills</Text>
        ...
        <View className="mx-4 bg-white rounded-2xl shadow-lg mb-6">
          ...
          <View className="w-full h-52 bg-gray-200 relative items-center justify-center overflow-hidden">
            <Image source={{ uri: 'https://images.unsplash.com/photo-1601933470928-c5d8f308b2ee' }} className="w-full h-52" resizeMode="cover" />
            <TouchableOpacity className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#8A5CFF] w-14 h-14 rounded-full items-center justify-center opacity-95 border-4 border-white">
          ...
          <View className="flex-row items-center justify-between px-4 py-2">
            <TouchableOpacity className="bg-[#FF4F4F] px-5 py-2 rounded-lg">
              <Text className="text-white font-bold text-sm">End Live</Text>
            </TouchableOpacity>
            <View className="flex-row items-center space-x-5">
              <View className="flex-row items-center"><Ionicons name="heart" size={16} color="#FF4F4F" /><Text className="ml-1 text-gray-800 font-bold text-xs">24</Text></View>
              <View className="flex-row items-center"><Ionicons name="eye" size={16} color="#6366F1" /><Text className="ml-1 text-gray-800 font-bold text-xs">12</Text></View>
              <View className="flex-row items-center"><Ionicons name="thumbs-up" size={16} color="#22c55e" /><Text className="ml-1 text-gray-800 font-bold text-xs">89</Text></View>
            </View>
          </View>
        </View>
        ...
        <View className="mx-4 bg-white rounded-2xl p-5 mb-10">
          ...
          <View className="space-y-2">
            {[
              ...
              <View key={idx} className="bg-[#f3f4f6] rounded-xl px-4 py-3">
